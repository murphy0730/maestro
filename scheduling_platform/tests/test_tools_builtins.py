...
from scheduling_platform.mcp.manager import MCPManager
from scheduling_platform.mcp.types import (
    MCPResource,
    MCPServerConfig,
    MCPServerConnection,
...
from scheduling_platform.tools.base import ToolDef, ToolResult, build_tool
from scheduling_platform.tools.builtins import register_all_builtins
from scheduling_platform.tools.mcp_resources import create_mcp_resource_tools
...
from scheduling_platform.foundation.tools.registry import ToolRegistry as FoundationRegistry
from scheduling_platform.skills.parser import parse_skill_md, validate_allowed_tools
...
async def test_bridge_with_gate_creates_pending_and_executes_on_confirm(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr(
        "scheduling_platform.tools.builtins.filesystem.project_root", lambda: tmp_path)
