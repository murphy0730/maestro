...
`maestro/src/maestro/tools/` 是平台的通用工具框架，借鉴 Claude Code 的三层工具模型：
...
from maestro.tools import ToolDef, ToolResult, ToolResultStatus, build_tool, ToolPermissionLevel
...
```python
from maestro.tools import initialize_tools, ToolManager
