...
const skill = { name: 'quality', display_name: '质量分析', description: 'SPC', user_invocable: true, scripts: ['run.py'], file_count: 2, bytes: 12, added_at: '', package_sha256: 'sha', trust: { level: 'untrusted' as const, valid: false, package_sha256: 'sha' } } satisfies SkillMeta;
...
describe('SkillMenu', () => {
  it('searches, selects, clears, trusts and opens import through real callbacks', () => {
    ...
    render(<SkillMenu open skills={[skill]} selected={[skill]} onToggleSkill={onToggleSkill} onClear={onClear} onImportSkill={onImportSkill} onTrustSkill={onTrustSkill} />);
