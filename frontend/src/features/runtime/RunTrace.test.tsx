...
const projection = { tokens: '', diagnostics: [], recovered: false, upgradeReason: 'write', run: { run_id: 'r1', session_id: 's1', objective: 'x', path: 'structured' as const, status: 'waiting_approval' as const, steps: {}, final_text: null, revision: 2, pending_approvals: [{ approval_id: 'a1', step_id: 's1', impact_summary: '写入 MES', policy_reason: 'high risk', run_revision: 2, status: 'pending' as const }] } };
describe('RunTrace', () => {
  afterEach(cleanup);
