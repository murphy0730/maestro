...
export function Workspace() {
  const [clock, setClock] = useState('--:--:--'); const [expert, setExpert] = useState(false); const [skills, setSkills] = useState<SkillMeta[]>([]); const [approvingId, setApprovingId] = useState<string | null>(null); const [importOpen, setImportOpen] = useState(false);
