...
SOURCES = [
    ...
    CatalogSource(id="anthropics-skills", kind="skill", display_name="Anthropic Skills", owner="anthropics", repo="skills", source_url="https://github.com/anthropics/skills", paths=["skills/pdf", "skills/slides", "skills/spreadsheets", "skills/docs"]),
